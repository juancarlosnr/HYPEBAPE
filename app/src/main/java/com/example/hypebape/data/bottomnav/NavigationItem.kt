package com.example.hypebape.data.bottomnav
...
sealed class NavigationItem(val route: String, val label: String, val icons: ImageVector) {
    ...
    object Detail:NavigationItem("detail/{idSneaker}", "Detail", Icons.Default.Close){
        fun createRoute(idSneaker:Int) = "detail/$idSneaker"
    }
